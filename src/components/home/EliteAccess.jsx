      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="aspect-square bg-[#1c1b1b] rounded-tl-[4rem] relative overflow-hidden shadow-2xl group cursor-pointer focus:outline-none" tabIndex="0">
              <img src={SITE_CONTENT.membership.image} alt="" className="absolute inset-0 w-full h-full object-cover opacity-60 mix-blend-luminosity group-hover:mix-blend-normal group-focus:mix-blend-normal transition-all duration-300 group-hover:scale-105 group-focus:scale-105" />
