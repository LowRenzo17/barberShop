  ...
  return (
    <section className="relative min-h-[90vh] flex items-center pt-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full flex flex-col md:flex-row items-center gap-12">
        ...
        >
          <div className="aspect-[4/5] bg-[#1c1b1b] rounded-tr-[4rem] rounded-bl-[4rem] relative overflow-hidden group cursor-pointer focus:outline-none" tabIndex="0">
             <img src={SITE_CONTENT.hero.image} alt="Barbershop view" className="absolute inset-0 w-full h-full object-cover opacity-80 mix-blend-luminosity group-hover:mix-blend-normal group-focus:mix-blend-normal transition-all duration-300 group-hover:scale-105 group-focus:scale-105" />
